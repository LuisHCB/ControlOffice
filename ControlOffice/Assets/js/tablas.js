...
function CargarSolicitudesElectronicos() {
    ...
    jqGridStart('tabla1', 'paginador-tabla1', 'electronicos/listaSolicitudElectronicos', config, 'Id_electronico');
}
...
function CargarSolicitudesMobiliarios() {
    ...
    jqGridStart('tabla1', 'paginador-tabla1', 'mobiliario/listaSolicitudMobiliarios', config, 'Id_mobiliario');
}